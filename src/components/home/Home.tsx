  ...
  return (
    <section className="home h-screen w-screen">
      <nav className="text-white flex justify-between items-center w-screen py-[2%] px-[10%] lg:px-[5%] sm:py-[5%]">
        <p className="font-secondary font-normal text-3xl sml:text-xl">ARTSY</p>
      ...
      <article className="flex justify-center items-center h-4/5 mt-[2%] w-screen ">
        <div className="w-3/5 text-center h-auto md:w-full md:px-8 ">
          <h2 className="font-primary font-bold text-[28px] text-white mb-[5%] md:text-2xl">
            A journal of creativity
          </h2>
          <p className="text-white font-secondary font-normal text-[50px] mb-[5%] tracking-wider md:text-[40px] sm:text-[30px]">
            FROM THE STUDIO TO YOUR DOORSTEP
          </p>
          <a
            href="/signup"
